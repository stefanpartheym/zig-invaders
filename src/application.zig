...
/// TODO:
/// To make things more flexible, implement an `ApplicationBackend` struct, that
/// is passed to `Application.init(...)`. This way, one could implement an
/// `ApplicationBackend` specifically for raylib and other libraries.
